...
void loop() {
  ...
  if(digitalRead(spacekey) == LOW){
    //meant to send a spacekey
    Keyboard.press(' ');
    }
   else{
     Keyboard.releaseAll();
...
//below corrects reading by mathematically remapping the current center and its readings to an estimated true center
  if (reading < 755){
